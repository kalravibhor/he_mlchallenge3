###catboost with cross validation setup
# coding: utf-8
...
model = CatBoostClassifier(depth=10, iterations=10, learning_rate=0.07, eval_metric='AUC',rsm=0.7,auto_stop_pval=0.001, thread=nthread, verbose=True)
